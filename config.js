...
export const HINT = [
    ...
    {
        title: "Will you be doing airdops?",
        description: "The plan is to periodically reward people who are still storing NFT’s in our vaults. We may occasionally send you $Dusty but also our partners, who value diamond handed people like yourself, might also want us to send out some goodies in the form of NFT’s or their own tokens from time to time. Gotta be in it, to win it!"
    },
    {
        title: "What do you do with the funds?",
        description: "The first responsibility of the treasury is to build the treasury funds so that if necessary we can buy back our $Dusty on the open market, providing a floor in the price and making sure our clients funds are not diluted. Everything after that is just building value."
    },
    {
        title: "Are you audited?",
        description: "In all seriousness the safety of your NFT’s and your funds is #1, 2 & 3 priority for this team. It’s not marketing, it’s not scaling, it’s security. We don’t need new users to make this work, but we do need a watertight storage unit and that will come with audits. They take time, but they will happen. Guaranteed."
    },
    {
        title: "What blockchains are you on?",
        description: "We’re starting life on Binance (BSC). Other chains will be added soon."
    },
    {
        title: "I can only see a black box where my NFT should be?",
        description: "This happens with certain NFT’s. We are looking to fix it, but it does not impact your ability to store it safely and earn $Dusty on it."
    }
]